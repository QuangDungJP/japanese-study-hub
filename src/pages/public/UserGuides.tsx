        ...
        },
        {
          ...
          subsections: [
            ...
            },
            {
              ...
              steps: [
                '📅 Xem các buổi học Meeting sắp tới',
          ...
          subsections: [
            {
              ...
              steps: [
                ...
                '💬 Tham gia lớp Meeting để tương tác với giáo viên',
    ...
    teacher: {
      ...
      sections: [
          ...
          subsections: [
            {
              ...
              steps: [
                ...
                '🎥 Lịch Meeting - Lên lịch các buổi lớp trực tuyến',
        ...
        },
        {
          ...
          subsections: [
            {
              title: 'Tạo buổi Meeting',
              content: 'Để tạo buổi Meeting:',
              steps: [
                '1️⃣ Nhấp vào "Lịch Meeting" trong sidebar',
                '2️⃣ Nhấp nút "Lên lịch buổi Meeting"',
                '3️⃣ Chọn lớp',
                '4️⃣ Đặt ngày, giờ và thời lượng',
                '5️⃣ Thêm chủ đề/nội dung buổi học',
                '6️⃣ Tạo/nhập liên kết Meeting',
                '7️⃣ Lưu',
              ],
            },
            {
              title: 'Quản lý buổi Meeting',
              content: 'Sau khi tạo buổi Meeting:',
              steps: [
                '📅 Xem tất cả các buổi Meeting sắp tới',
                '📝 Chỉnh sửa chi tiết buổi Meeting',
          ...
          subsections: [
            {
              ...
              steps: [
                ...
                '5️⃣ Chọn địa điểm hoặc liên kết Meeting',
